...
public class WalletItemControllerTest {
    ...
    public void testSumByWallet() throws Exception{
        BigDecimal value = BigDecimal.valueOf(536.9);
    ...
    public void testUpdateWalletChange() throws Exception {
        ...
        .andExpect(jsonPath("$.erros[0]").value("Voce nao pode alterar a carteira"));
    ...
    public void testUpdateInvalidId() throws Exception{
        ...
        .andExpect(status().isBadRequest())
        .andExpect(jsonPath("$.data").doesNotExist())
        .andExpect(jsonPath("$.erros[0]").value("WalletItem nao encontrado")); 
    }
    ...
    public void testDelete() throws JsonProcessingException, Exception{
        ...
        mvc.perform(MockMvcRequestBuilders.delete(URL + "/1").content(getJsonPayload())
            .contentType(MediaType.APPLICATION_JSON)
            .accept(MediaType.APPLICATION_JSON))
        .andExpect(status().isOk())
    ...
    public void testDeleteInvalid() throws JsonProcessingException, Exception{
        ...
        mvc.perform(MockMvcRequestBuilders.delete(URL + "/99").content(getJsonPayload())
            .contentType(MediaType.APPLICATION_JSON)
            .accept(MediaType.APPLICATION_JSON))
        .andExpect(status().isNotFound())
        .andExpect(jsonPath("$.data").doesNotExist())
        .andExpect(jsonPath("$.erros[0]").value("Carteira de id " + 99 + " nao encontrada"));
    }
    ...
    public String getJsonPayload() throws JsonProcessingException{
        ...
        dto.setDate(format.format(DATE));
